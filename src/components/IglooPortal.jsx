    ...
    const getStatusInfo = () => {
        ...
        if (!isRented && !isReserved) {
            return {
                ...
                subtitle: `${IGLOO_CONFIG.DAILY_RENT_CPW3?.toLocaleString() || '10,000'} CPw3/day`,
                description: `Min balance: ${IGLOO_CONFIG.MINIMUM_BALANCE_CPW3?.toLocaleString() || '70,000'} CPw3`,
                color: 'emerald',
                canEnter: false,
                ...
                {status.showRentInfo && (
                    <div className="bg-black/30 rounded-lg p-2 mb-2 text-xs">
                        <div className="flex items-center justify-center gap-2 text-emerald-300">
                            <span>📅 Daily:</span>
                            <span className="font-mono">{IGLOO_CONFIG.DAILY_RENT_CPW3?.toLocaleString()} CPw3</span>
                        </div>
